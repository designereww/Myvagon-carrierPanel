					...
					<form>
						<div>
		                	...
		                	<div class="w-full mt-5 select_design">
	                            ...
	                            <button class="border grayBorder bg-white block w-full blurColor60 font-medium block text-start rounded-2xl 2xl:px-5 2xl:py-4 p-3 pr-12 bg-[url('images/arrow-down.svg')] bg-no-repeat 2xl:bg-[center_right_1rem] bg-[center_right_0.5rem] modalButton" data-target="#edit-driver-assign-vehicle">
						...
						<div class="2xl:mt-10 mt-5">
		                	...
		                	<div class="grid lg:grid-cols-4 grid-cols-2 items-end lg:gap-5 gap-3 2xl:mt-7 mt-4">
                                ...
                                <div class="date_picker relative">
                                    <div class="datepiker_wrapper">
                                        <input type="text" class="border bg-white extradarkgreyColor block rounded-2xl p-3 w-full mt-2 bg-[url('images/calendar_icon.svg')] pr-10 bg-[center_right_1rem] bg-no-repeat" placeholder="Time">
		                ...
		                <div class="2xl:mt-10 mt-5 text-end">
		                	<button class="darkblur_btn font-medium border-r20 2xl:p-4 p-3 2xl:w-1/4 modalButton">Save Changes</button>
		                </div>
					</form>
				</div>
			</div>
...
<!-- assing driver modal -->
<div class="modal" id="edit-driver-assign-vehicle">
