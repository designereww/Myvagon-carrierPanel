...
<section class="load_detail_main smallfont">
	<div class="flex lg:flex-nowrap flex-wrap xl:gap-10 gap-5">
		...
		<div class="xl:w-4/6 lg:w-1/2 w-full pt-12 relative">
			<div>
				<label class="yelloLoad_lable border-r30 rounded-t-none 2xl:w-[380px] w-[230px] p-2.5 block text-center absolute top-0 right-0 text-xl smallfont font-medium">No Bids Received</label>
			</div>
			<div class="p-1 mt-10">
				...
				<div class="2xl:mt-16 mt-10 text-center">
					<button class="darkblur_btn font-medium border-r20 2xl:p-4 p-3 2xl:w-1/3 modalButton" data-target="#load-assign-vehicle" data-toggle="modal">Bid Now</button>
				</div>
			</div>
		</div>
	</div>
