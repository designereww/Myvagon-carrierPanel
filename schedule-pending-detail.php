	...
	<div class="flex lg:flex-nowrap flex-wrap xl:gap-10 gap-5">
		<div class="xl:w-2/6 lg:w-1/2 w-full greyBG text-sm">
			...
			<div class="2xl:p-6 p-4 manage_load_ontrip">
				...
				<button class="redColor borderRed border-r20 py-5 w-full mt-5 font-medium">Withdraw Bid</button>
			</div>
		</div>
		<div class="xl:w-4/6 lg:w-1/2 w-full pt-12 relative">
			<div>
				<label class="yelloLoad_lable border-r30 rounded-t-none 2xl:w-[380px] w-[230px] p-2.5 block text-center absolute top-0 right-0 text-xl smallfont font-medium">Pending</label>
			</div>
