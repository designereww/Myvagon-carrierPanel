...
<section class="load_detail_main smallfont relative">
	<div class="schedule_ready_status relative">
		<div class="flex lg:flex-nowrap flex-wrap xl:gap-10 gap-5 lg:pt-0 pt-12">
			<div class="xl:w-2/6 lg:w-1/2 w-full">
				<ul class="nav nav-tabs flex items-center text-center borderpurple border-t-0 bg-semilightapurple text-lg smallfont">
		            <li class="nav-item w-1/2 navtab_active">
		              	<a class="nav-link block p-4 font-medium" href="#updated_load">Updated Load</a>
		            </li>
		            <li class="nav-item w-1/2">
		              	<a class="nav-link block p-4 font-medium" href="#original_load">Original Load</a>
		            </li>
		        </ul>
			</div>
			<div class="xl:w-4/6 lg:w-1/2 w-full pt-12"></div>
		</div>
		<div class="tabView">
			<div class="tab-content overflow-x-auto">
				<div class="tab-pane active" id="updated_load">	
					<div class="flex lg:flex-nowrap flex-wrap xl:gap-10 gap-5">
						<div class="xl:w-2/6 lg:w-1/2 w-full greyBG text-sm">
							...
							<div class="2xl:p-6 p-4 manage_load_ontrip">
								...
								<div class="h-[600px] pr-1 overflow-y-auto xl:mt-8 mt-4">
									<div class="location-box pl-10">
										<div data-marked="false" data-update="true" class="location-box_card relative text-xs rounded-2xl bg-white mb-6">
											<div class="location-label smallfont relative">PICKUP<span class="new_data_added hidden absolute left-[10px] top-[7px] bg-red text-white text-xs smallfont 2xl:py-2 py-1 px-4 rounded-2xl">New</span></div>
											<div class="content-wrapper">
												...
												<div class="2xl:p-5 p-3 text-sm smallfont">
													...
													<div class="xl:py-5 py-3 xl:px-6 px-3 location_orderList">
														...
														<label class="block font-semibold mb-2">Colis Morphs</label>
														<div class="font-medium">
															<label class="pl-6 border-r bg-[url('images/load-truck.svg')] bg-no-repeat bg-[left_center] darkgreyColor pr-3 mr-2 align-middle updatedLoad">5 Tons</label>
															<label class="pl-6 bg-[url('images/load-truck-weight.svg')] bg-no-repeat bg-[left_center] darkgreyColor align-middle">10 X Pallets</label>
														</div>
													</div>
												</div>
										...
										<div data-marked="true" data-update="false" class="location-box_card relative text-xs rounded-2xl bg-white mb-6">
										...
										<div data-marked="false" data-update="false" class="location-box_card relative text-xs rounded-2xl bg-white mb-6">
										...
										<div data-marked="true" data-update="false" class="location-box_card relative text-xs rounded-2xl bg-white">
											<div class="location-label smallfont">DROP-OFF</div>
											<div class="content-wrapper">
												<div class="xl:flex items-start justify-between 2xl:p-5 p-3">
													<label class="block w-2/4 text-base smallfont font-semibold mb-1">Abc Company</label>
						...
						<div class="xl:w-4/6 lg:w-1/2 w-full pt-6">
							<div>
								<label class="ready_trip_blue border-r30 rounded-t-none 2xl:w-[380px] w-[230px] p-2.5 block text-center absolute top-0 right-0 text-xl smallfont font-medium">Ready</label>
							</div>
							<div class="purpleBorder border-r20 mt-10 assign_trip_driver">
								...
								<div class="expanedDriverExpand">
									<div class="xl:flex justify-between px-7 py-4">
				                         ...
				                         <div class="flex gap-10 items-center justify-between">
				                         	...
				                         	<div>
				                         		<button class="py-2 px-10 darkblueColor borderBlue bg-white border-r18 text-sm font-medium smallfont modalButton" data-target="#schedule_change_driver_list">Change Driver</button>
				                         	</div>
				                         </div>
				     				</div>
								</div>
									...
									<div class="group outline-none accordion-section" tabindex="1">
						     		...
						     		<div class="group outline-none accordion-section" tabindex="2">
						         			...
						         			<div class="transition ease duration-500 text-xl smallfont w-full">
						         				<div class="xl:flex justify-between">
							                         ...
							                         <div class="flex gap-10 items-center me-5 justify-between">
							                         	...
							                         	<div>
							                         		<button class="py-2 px-10 darkblueColor borderBlue bg-white border-r18 text-sm font-medium smallfont modalButton" data-target="#trip_change_driver">Remove Driver</button>
							                         	</div>
							                         </div>
						         				</div>
									         </div>
						       			...
						       			<div>
									       	...
									       	<div class="group-focus:max-h-screen max-h-0 overflow-hidden ease duration-500">
									         	<div class="text-sm smallfont flex justify-between py-3 px-7 border-t borderpurple border-0">
									         		<div class="flex items-start gap-3">
									         			<img src="images/Change-over-location.svg">
									         			<div>
											         		<p class="font-medium purplecolor">Change Over Location</p>
							...
							<div class="p-1 mt-10">
								...
								<div class="grid xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-2 grid-cols-1 gap-5">
									<div>
										...
										<div class="xl:p-4 p-3 borderpurple border-r20 flex items-center gap-5">
									...
									<div>
										...
										<div class="xl:p-4 p-3 borderpurple border-r20 flex items-center justify-between gap-5">
								        	<img src="images/truck.png" class="w-28 h-auto object-contain">
								        	<div>
								...
								<div class="borderlightpurple border-r20 p-4 my-7">
									<label class="block mb-1.5 text-sm smallfont font-semibold">Alert</label>
									<p class="mb-0 redColor">The Shipper has modified the original load. Please indicate whether you accept the new itinerary or you reject the update, which will preserve the original load.</p>
								</div>
								<div class="2xl:mt-16 mt-10 text-center">
									<button class="w-1/2 borderRed redColor font-medium border-r20 2xl:p-4 p-3">Cancel Load</button>
								</div>
							</div>
						</div>
					</div>
				</div>
				<div class="tab-pane" id="original_load">	
					<div class="flex lg:flex-nowrap flex-wrap xl:gap-10 gap-5">
						<div class="xl:w-2/6 lg:w-1/2 w-full greyBG text-sm">
							<div class="2xl:p-6 xl:p-4 p-3 purpleBottom">
								<label class="text-2xl largefont font-medium extradarkgreyColor">Order ID: <span class="font-semibold darkblueColor">#BA765412dss</span></label>
							</div>
							<div class="2xl:p-6 p-4 manage_load_ontrip">
								<label class="text-xl smallfont font-medium">Itinerary Details</label>
								<div class="h-[600px] pr-1 overflow-y-auto xl:mt-8 mt-4">
									<div class="location-box pl-10">
										...
										<div data-marked="true" class="location-box_card relative text-xs rounded-2xl bg-white mb-6">
											<div class="location-label smallfont">DROP-OFF</div>
											<div class="content-wrapper">
												<div class="xl:flex items-start justify-between 2xl:p-5 p-3">
													<label class="block w-2/4 text-base smallfont font-semibold mb-1">Abc Company</label>
						...
						<div class="xl:w-4/6 lg:w-1/2 w-full pt-6">
							...
							<div class="p-1 mt-10">
								...
								<div class="grid grid-cols-2 gap-5 2xl:mt-16 mt-10">
									<button class="borderBlue darkblueColor font-medium border-r20 2xl:p-4 p-3">Withdraw Bid</button>
									<button class="borderRed redColor font-medium border-r20 2xl:p-4 p-3">Cancel Load</button>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="flex lg:flex-nowrap flex-wrap xl:gap-10 gap-5">
			<div class="xl:w-2/6 lg:w-1/2 w-full schedule_ready_tab_button">
		        <div class="2xl:p-6 p-4 flex items-center lg:gap-5 gap-3">
		        	<button class="w-1/2 borderpurple text-center p-2 2xl:py-3 border-r20 purplecolor font-medium modalButton" data-target="#schedule_ready_reject">Reject Update</button>
                    <button class="w-1/2 bg-darkpurple text-center p-2 2xl:py-3 border-r20 text-white font-medium borderpurple">Accept Update</button>
		        </div>   
			</div>
			<div class="xl:w-4/6 lg:w-1/2 w-full pt-12"></div>
		</div>
...
<!-- schedule reject modal -->
<div class="modal" id="schedule_ready_reject">
    <div class="modal-dialog modal-dialog-centered smallfont">
        <div class="modal-content md:p-7 p-4">
            <div class="modal-header xl:pb-5 pb-2">
                ...
                <div class="text-center text-2xl largefont 2xl:pt-6 pt-4 darkpurpleColor font-medium">Rejection Reason</div>
            </div>
            <div class="modal-body py-2">
                <div class="my-5 text-lg smallfont">
                	<div class="my-6">
                        <input type="radio" id="reason1" name="rejection-reason" class="hidden radioCustom_btn radioButton_reject" />
                        <label for="reason1">Rate too low</label>
                    </div>
                    <div class="my-6">
                        <input type="radio" id="reason2" name="rejection-reason" class="hidden radioCustom_btn radioButton_reject" />
                        <label for="reason2">Pickup window</label>
                    </div>
                    <div class="my-6">
                        <input type="radio" id="reason3" name="rejection-reason" class="hidden radioCustom_btn radioButton_reject" />
                        <label for="reason3">Delivery window</label>
                    </div>
                    <div class="my-6">
                        <input type="radio" id="reason4" name="rejection-reason" class="hidden radioCustom_btn radioButton_reject" />
                        <label for="reason4">Equipment issue</label>
                    </div>
                    <div class="my-6">
                        <input type="radio" id="reason5" name="rejection-reason" class="hidden radioCustom_btn radioButton_reject" />
                        <label for="reason5">Delayed by previous receiver</label>
                    </div>
                    <div class="my-6">
                        <input type="radio" id="reason6" name="rejection-reason" class="hidden radioCustom_btn radioButton_reject" />
            ...
            <div class="modal-footer 2xl:mt-10 mt-5">
                <div class="flex items-center lg:gap-5 gap-3">
                    <button class="w-1/2 borderBlue text-center p-2 2xl:py-3 border-r20 font-medium close_icon">Cancel</button>
                    <button class="w-1/2 bg-red text-center p-2 2xl:py-3 border-r20 text-white borderRed font-medium">Reject</button>
                </div>
            </div>
        </div>
    </div>
