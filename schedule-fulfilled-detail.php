	...
	<div class="flex lg:flex-nowrap flex-wrap xl:gap-10 gap-5">
		<div class="xl:w-2/6 lg:w-1/2 w-full greyBG text-sm">
			...
			<div class="2xl:p-6 p-4 manage_load_ontrip">
				...
				<div class="h-[650px] pr-1 overflow-y-auto mt-8">
					<div class="location-box pl-10">
						<div data-marked="false" data-track="true" class="location-box_card relative text-xs rounded-2xl bg-white mb-6 ">
							...
							<div class="content-wrapper">
								...
								<div class="2xl:p-5 p-3 text-sm smallfont">
									<div class="xl:py-5 py-3 xl:px-6 px-3 location_orderList mb-3 afterRecevied">
						...
						<div data-marked="true" data-track="true" class="location-box_card relative text-xs rounded-2xl bg-white mb-6">
							<div class="location-label smallfont track_status_truck">DROP-OFF</div>
							<div class="content-wrapper">
								<div class="xl:flex items-start justify-between 2xl:p-5 p-3">
									<label class="block w-2/4 text-base smallfont font-semibold mb-1">Abc Company</label>
									<div class="text-sm smallfont text-right">
						...
						<div data-marked="true" data-track="true" class="location-box_card relative text-xs rounded-2xl bg-white">
							<div class="location-label smallfont track_status_truck">DROP-OFF</div>
							<div class="content-wrapper">
								<div class="xl:flex items-start justify-between 2xl:p-5 p-3">
									<label class="block w-2/4 text-base smallfont font-semibold mb-1">Abc Company</label>
				...
				<div class="flex items-center xl:gap-5 gap-3">
					<button class="w-1/2 darkpurpleColor borderpurple border-r20 py-5 mt-5 font-medium">View POD</button>
					<button class="w-1/2 bg-darkpurple text-white border-r20 py-5 mt-5 font-medium modalButton" data-target="#rate_review_ship">Rate Shipper</button>
				</div>
			</div>
		</div>
		<div class="xl:w-4/6 lg:w-1/2 w-full pt-12 relative">
			<div>
				<label class="fulfilled border-r30 rounded-t-none 2xl:w-[380px] w-[230px] p-2.5 block text-center absolute top-0 right-0 text-xl smallfont font-medium">fulfilled</label>
			</div>
			<div class="p-1 mt-10">
				<div class="grid grid-cols-2 xl:gap-5 gap-3">
					<div class="purpleBorder border-r20">
						<p class="text-base smallfont purplecolor font-medium purpleBottom px-7 py-4">Assigned Drivers</p>
						<div class="flex items-center 2xl:gap-5 gap-3 px-7 py-4">
					...
					<div class="purpleBorder border-r20">
						<p class="text-base smallfont purplecolor font-medium purpleBottom px-7 py-4">POD</p>
						<div class="flex items-center 2xl:gap-5 gap-3 px-7 py-4">
                            
                         </div>
					</div>
				</div>
				<div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-5 my-7">
					<div class="purpleBorder border-r20 p-4">
				...
				<div class="grid xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-2 grid-cols-1 gap-5">
					<div>
						<label class="block text-sm smallfont font-bold mb-4 darkpurpleColor">Shipper Details</label>
						<a href="shipper-ratings.php" class="xl:p-4 p-3 purpleBorder border-r20 flex items-center gap-5">
					...
					<div>
						<label class="block text-sm smallfont font-bold mb-4 darkpurpleColor">Vehicle Details</label>
...
<!-- Rating & review shipper modal  -->
<div class="modal" id="rate_review_ship">
    <div class="modal-dialog modal-dialog-centered smallfont">
        <div class="modal-content md:p-7 p-4">
            <div class="modal-header xl:pb-5 pb-2">
                ...
                <div class="text-center text-2xl largefont 2xl:pt-6 pt-4 darkpurpleColor font-semibold">Rate & Review Shipper</div>
            </div>
            <div class="modal-body py-2 text-wcenter">
                <div class="text-center text-lg smallfont">
                   How would you like to Rate the <span class="font-bold darkpurpleColor">Shipper?</span>
                </div>
                <div class="notifi_count_bg border-r20 p-4 2xl:mt-10 mt-5">
                	<div class="stars">
						<input class="stars__checkbox" type="radio" id="first-star" value="5" name="rating">
						...
						<input class="stars__checkbox" type="radio" id="second-star" value="4" name="rating">
						...
						<input class="stars__checkbox" type="radio" id="third-star" value="3" name="rating">
						...
						<input class="stars__checkbox" type="radio" id="fourth-star" value="2" name="rating">
						...
						<input class="stars__checkbox" type="radio" id="fifth-star" value="1" name="rating">
                ...
                <div class="2xl:mt-10 mt-5">
                	<textarea class="blurColor60 text-base smallfont resize-none w-full notifi_count_bg border-r20 px-6 py-4 h-40" placeholder="Write your Review"></textarea>
                </div>
            </div>
            <div class="modal-footer 2xl:mt-10 mt-5">
                <div class="flex items-center lg:gap-5 gap-3">
                    <button class="w-1/2 borderBlue text-center p-2 2xl:py-3 border-r20 close_icon font-medium">Not Now</button>
                    <button class="w-1/2 bg-darkblue text-center p-2 2xl:py-3 border-r20 text-white borderBlue text-white">Submit</button>
                </div>
            </div>
        </div>
    </div>
