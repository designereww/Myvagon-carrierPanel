...
<section class="publicload_sec loadTab_sec smallfont">
    <div class="mt-8">
        <div class="dash_search_box mb-8">
            <div class="input-group flex sm:flex-nowrap flex-wrap align-items gap-5 justify-end sm:mx-0 mx-5">
            	...
            	<button class="bg-semilightapurple flex items-center justify-center border-r20 p-2 fil_btn modalButton" data-target="#public_load_filter"><img
                    src="images/filter-icon.svg" class="w-1/2"></button>
            	<button class="bg-semilightapurple flex items-center justify-center border-r20 p-2 fil_btn modalButton" data-target="#public_load_sort_by"><img
            ...
            <div class="text-sm smallfont font-medium text-center">
                ...
                <div class="mt-10">
                    <div class="h-[650px] overflow-auto">
                        <a class="px-6 py-4 purpleBorder border-r20 relative my-3 block" href="load-details.php">
                            <div class="grid grid-cols-12 lg:gap-2 gap-4 items-center">
                                        ...
                                        <div class="grid sm:grid-cols-2 gap-x-2 items-start mt-5 md:gap-y-3">
                                            <div class="about_loca_icon_bg">
                                                <div class="relative stop_before stop_count z-10">
                                                    <label
                                                        class="text-base smallfont blurColor60 block mb-3 mb-3 2xl:mt-0 mt-1 bg-white inline-block pe-1">ABC
                                                        INC</label>
                                                    <p class="mb-2 w-9/12"><span class="font-semibold">Mithimnis 30,</span>
                                                        Athina 112 57, Greece</p>
                                                    <label class="about_date_icon inline-block mb-1 me-4">March 17th, 2023</label>
                                                    <label class="about_time_icon inline-block inline-block mb-2">08:30</label>
                                            ...
                                            <div class="about_flag_icon_bg">
                                                <div class="">
                                                    ...
                                                    <label class="about_date_icon inline-block mb-1 me-4">March 17th, 2023</label>
                                                    <label class="about_time_icon inline-block">18:30</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-end lg:col-start-10 lg:col-end-13 sm:col-start-9 sm:col-end-13 col-span-full">
                                    ...
                                    <button class="darkblur_btn 2xl:p-4 lg:p-3 p-2 text-base smallfont border-r20 modalButton" data-target="#load-assign-vehicle">Bid Now</button>
...
<div class="modal" id="public_load_filter">
...
<div class="modal" id="public_load_sort_by">
    <div class="modal-dialog modal-dialog-lefted smallfont">
        <div class="modal-content">
            <div class="modal-header 2xl:p-7 p-4 grayBorder flex items-center justify-between">
