...
<section class="load_detail_main smallfont">
	<div class="flex lg:flex-nowrap flex-wrap xl:gap-10 gap-5">
		<div class="xl:w-2/6 lg:w-1/2 w-full greyBG text-sm smallfont">
			<div class="2xl:p-6 xl:p-4 p-3 purpleBottom flex items-center justify-between">
				...
				<label class="inline-block py-2 2xl:px-10 px-4 bg-[#1F1F412B] rounded-xl">Partner</label>
			</div>
		...
		<div class="xl:w-4/6 lg:w-1/2 w-full pt-12 relative">
			<div>
				<label class="load_bid_panding border-r30 rounded-t-none 2xl:w-[380px] w-[230px] p-2.5 block text-center absolute top-0 right-0 text-xl smallfont font-medium">Pending</label>
			</div>
			<div class="p-1 mt-10">
				...
				<div class="2xl:mt-16 mt-10 flex items-center lg:gap-5 gap-3 text-white">
                    <button class="w-1/2 bg-red text-center p-2 2xl:py-3 border-r20">Decline</button>
                    <button class="w-1/2 bg-green text-center p-2 2xl:py-3 border-r20 modalButton" data-target="#private_load_interested_driver_list">I'm interested</button>
                </div>
			</div>
		</div>
	</div>
...
<!-- private bid load detail reject modal -->
<div class="modal" id="private-bid-load-react">
        ...
        <div class="modal-content md:p-7 p-4">
            ...
            <div class="modal-footer 2xl:mt-10 mt-5">
                <div class="flex items-center lg:gap-5 gap-3">
                    ...
                    <button class="w-1/2 bg-darkblue text-center p-2 2xl:py-3 border-r20 text-white borderBlue">Reject Bid</button>
                </div>
            </div>
        </div>
    </div>
